...
contains(CONFIG, staticlib) {
    DEFINES += GENESISX_FRAMEWORK_STATIC
} else {
    DEFINES += GENESISX_FRAMEWORK_LIBRARY
}
...
message([framework] DESTDIR = $$DESTDIR)
...
INCLUDEPATH += $$GENESISX_BUILD_ROOT/framework/include
